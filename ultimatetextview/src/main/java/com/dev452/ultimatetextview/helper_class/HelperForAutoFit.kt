package com.dev452.ultimatetextview.helper_class
...
import com.dev452.ultimatetextview.R
 ...
 */
class HelperForAutoFit private constructor(private val mBackBoneTextView: BackBoneTextView) {
    ...
    companion object {
        ...
        fun cookStuffs(
            ...
            if (attrs != null) {
                ...
                sizeToFit = ta.getBoolean(R.styleable.UltimateTextView_UTVAutoFitEnabled, sizeToFit)
                minTextSize = ta.getDimensionPixelSize(
                    R.styleable.UltimateTextView_UTVMinTextSize,
                    minTextSize
                )
                ta.recycle()
